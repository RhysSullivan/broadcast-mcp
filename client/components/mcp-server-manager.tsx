...
export const MCPServerManager = ({
  ...
  const addServer = () => {
    ...
    if (newServer.type === "web" && !newServer.url) {
      toast.error("Server URL is required for Web transport");
      return;
    }
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2 grid-cols-3">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setNewServer({ ...newServer, type: "web" })
                      }
                      className={`flex items-center gap-2 p-3 rounded-md text-left border transition-all ${
                        newServer.type === "web"
                          ? "border-primary bg-primary/10 ring-1 ring-primary"
                    ...
                    >
                      <Globe2
                        className={`h-5 w-5 shrink-0 ${
                          newServer.type === "web" ? "text-primary" : ""
                        }`}
                      />
                      <div>
              ...
              {newServer.type === "sse" ? (
                ...
                <div className="grid gap-1.5">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    URL of the web page hosting the MCP server
                  </p>
                </div>
              ) : (
                <>
            ...
            <>
              ...
              <Button
                ...
                disabled={
                  ...
                  (newServer.type === "stdio" &&
                    (!newServer.command || !newServer.args?.length)) ||
                  (newServer.type === "web" && !newServer.url)
                }
              >
